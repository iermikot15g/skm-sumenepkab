            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <select name="role" 
                        ...
                        <option value="pimpinan_opd" {{ old('role', $user->role) == 'pimpinan_opd' ? 'selected' : '' }}>Pimpinan OPD</option>
                    </select>
                    @error('role')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <!-- OPD (conditional) -->
                <div id="opd_container" style="display: {{ in_array(old('role', $user->role), ['admin_opd', 'pimpinan_opd']) ? 'block' : 'none' }};">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Minimal 8 karakter. Isi hanya jika ingin mengubah password.</p>
                    @error('password')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>

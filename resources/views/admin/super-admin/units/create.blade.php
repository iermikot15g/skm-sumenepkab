...
@section('header', 'Tambah Unit Layanan Baru')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('super-admin.units.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('code') }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                           placeholder="DISPENDIK-001"
                           required>
                    <p class="text-xs text-gray-500 mt-1">Contoh: DISPENDIK-001, DINKES-002</p>
                    @error('code')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>

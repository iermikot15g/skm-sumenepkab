...
@section('header', 'Tambah Jenis Layanan Baru')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('admin-opd.services.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                           placeholder="Contoh: Pendaftaran Sekolah"
                           required>
                    <p class="text-xs text-gray-500 mt-1">Masukkan jenis layanan yang tersedia di unit ini</p>
                    @error('service_name')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>

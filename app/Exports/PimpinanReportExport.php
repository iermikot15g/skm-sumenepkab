...
class PimpinanReportExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected $filters;
    ...
    public function map($respondent): array
    {
        ...
        $education = $educationMap[$respondent->education] ?? $respondent->education;
        
        $occupation = $respondent->occupation == 'lainnya' 
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            ...
            'A1:X1' => ['fill' => ['fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID, 'startColor' => ['rgb' => '22C55E']]],
        ];
    }
}